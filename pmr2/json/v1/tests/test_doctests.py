...
def test_suite():
    return unittest.TestSuite([
        ...
        ztc.ZopeDocFileSuite(
            'dashboard.rst', package='pmr2.json.v1',
            test_class=WorkspaceDocTestCase,
            optionflags=doctest.NORMALIZE_WHITESPACE|doctest.ELLIPSIS,
        ),

        ztc.ZopeDocFileSuite(
            'document.rst', package='pmr2.json.v1',
            test_class=ptc.FunctionalTestCase,
            optionflags=doctest.NORMALIZE_WHITESPACE|doctest.ELLIPSIS,
        ),

        ztc.ZopeDocFileSuite(
            'exposure.rst', package='pmr2.json.v1',
            test_class=CompleteDocTestCase,
            optionflags=doctest.NORMALIZE_WHITESPACE|doctest.ELLIPSIS,
        ),

        ztc.ZopeDocFileSuite(
            'workspace.rst', package='pmr2.json.v1',
            test_class=WorkspaceDocTestCase,
            optionflags=doctest.NORMALIZE_WHITESPACE|doctest.ELLIPSIS,
        ),

        ztc.ZopeDocFileSuite(
            'topic.rst', package='pmr2.json.v1',
            test_class=ptc.FunctionalTestCase,
            optionflags=doctest.NORMALIZE_WHITESPACE|doctest.ELLIPSIS,
        ),
